...
public class HistoryInfo {
    ...
    public HistoryInfo(SharedPreferences MyPrefs) {
    ...
    public void myDebug() {
        ...
        Log.d(TAG, "HistoryInfo = mes dates : " + myDates + "");
        Log.d(TAG, "HistoryInfo = mes moods : " + myMoods + "");
        Log.d(TAG, "HistoryInfo = comments : " + myComments + "");
